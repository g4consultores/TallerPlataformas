...
$table2->addCell()->addText("$".number_format($product->price_out,0,"",","));
$table2->addCell()->addText("$".number_format($operation->q*$product->price_out,0,"",","));
$total+=$operation->q*$product->price_out;
}

$section1->addText("");
$section1->addText("Total: $".number_format($total,0,"",","),array("size"=>20));

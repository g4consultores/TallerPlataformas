...
<?php foreach($operations as $operation):?>
	<tr>
		...
		<td>$ <?php echo number_format($operation->discount,0,'',','); ?></td>
		<td>$ <?php echo number_format($operation->total-$operation->discount,0,'',','); ?></td>
...
<h1>Total de ventas: $ <?php echo number_format($supertotal,0,'',','); ?></h1>

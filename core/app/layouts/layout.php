    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>TIENDA</b>SYSTEM</span>
        </a>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright 2017 <a href="" target="_blank">Grupo4Consultores</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">TIENDA<b>SYSTEM</b></a>
      </div><!-- /.login-logo -->
